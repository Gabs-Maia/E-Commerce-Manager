...
public class JwtUtil {
    private String secret = "Lahulla_Gabs";
    ...
    public  String generateToken(String username, String role){Map<String, Object> claims = new HashMap<>();
    ...
    private String createToken(Map<String, Object> claims, String subject){
        return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
                ...
                .signWith((Key) SCryptPasswordEncoder.defaultsForSpringSecurity_v5_8()).compact();}
